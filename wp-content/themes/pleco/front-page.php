...
<main>
        ...
        <div class="hero-left-content">
          ...
          <div class="hero-stats">
            ...
            <div class="hero-stat">
              <p>
                契約継続率<br>
                <span class="value two" data-target="98">0</span>%
              </p>
            </div>
            <div class="hero-stat">
              <p>
                実績<br>
                年間<span class="value four" data-target="3000">0</span>件超
              </p>
            </div>
            <div class="hero-stat">
              <p>
                京都を中心に<br>
                <span class="value three" data-target="100">0</span>物件以上の<br>
                管理・清掃実績
              </p>
            </div>
          </div>
          ...
          <div class="hero-actions">
            ...
            <a class="btn btn-ghost btn-lg" href="simulation.html">料金プラン</a>
          </div>
        </div>
      </div>
      <div class="hero-right">
        <div class="main-visual-slides">
          <img src="<?php echo get_template_directory_uri(); ?>/images/hero/cleaning.jpg" alt="cleaning" class="main-visual-slide is-active">
          <img src="<?php echo get_template_directory_uri(); ?>/images/hero/bed.jpg" alt="bed" class="main-visual-slide">
          <img src="<?php echo get_template_directory_uri(); ?>/images/hero/amenity.jpg" alt="amenity" class="main-visual-slide">
          <img src="<?php echo get_template_directory_uri(); ?>/images/hero/bath.jpg" alt="bath" class="main-visual-slide">
          <img src="<?php echo get_template_directory_uri(); ?>/images/hero/cleaning.jpg" alt="cleaning" class="main-visual-slide">
        </div>
      </div>
    ...
    <div class="container">
      ...
      <section class="more-tile-wrapper fade-up">
        <a class="more-tile" href="/startup-support">
          <img src="<?php echo get_template_directory_uri(); ?>/images/designershotel.jpg" alt="民泊開業支援画像">
  ...
  <section  id="management" class="management overlap-section">
    ...
    <div class="container">
      ...
      <section class="opening-flow">
        <h3 class="underline-h3 fade-up">新規に旅館業の許可を取得される方</h3>
        <div class="opening-flow-container fade-up">

          <div class="opening-flow-image">
  ...
  <section id="price" class="price under-section">
    <div class="container">
      ...
      <div class="price-container">
        <h3>
          運営サポートは大きく分けると2つのコースがあります。
        </h3>

        <div class="price-cards">
          <!-- 運営代行プラン -->
          <article class="price-card price-card-startup">
            ...
            <div class="price-card-content">
              <div class="price-card-text">
                <p>
                  オーナー様⾃⾝が所有する物件を宿泊施設に⽤途変更をして、その運営を当社がサポートするプランです。<br>
                  サポートは運営の⼀部、或いは、すべてを丸投げできるプランをご⽤意しております。
                </p>
              </div>

              <img src="<?php echo get_template_directory_uri(); ?>/images/price/price-card1.png">
            </div>
          </article>

          <!-- 賃貸プラン -->
          <article class="price-card price-card-operation">
            <div class="price-card-head">
              <h4>賃貸運営プラン</h4>
            </div>
            ...
            <div class="price-card-content">
              <div class="price-card-text">
                <p>
                  賃貸プランは通常の賃貸物件のように当社がオーナー様から物件を賃貸して、宿泊施設を運営するプランです。<br>
                  ⼀般的な住居⽤としての賃貸の家賃単価より⾼い家賃設定をさせていただきます。
                </p>
              </div>

              <img src="<?php echo get_template_directory_uri(); ?>/images/price/price-card2.png" alt="賃貸プランイメージ画像">
            </div>
          </article>
        </div>  

        <a href="/price" class="price-plan-btn btn btn-lg">
          料金プランを見る
        </a>
  ...
  <section id="news" class="top-news under-section">
    <div class="container">
      ...
      <a href="/news" class="news-all-btn btn btn-lg">記事一覧はこちら</a>
    </div>
  </section>
